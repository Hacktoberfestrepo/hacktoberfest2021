...
int main()
{
    ...
    printf("*** Please use online gdb or visual code and if you are goin to use long words in your string...  zoom out by ctrl+(mouse scrolll down) coz it just overwrite the word codes for not having the required output area\n\n ENTER STRINGS OR LINE HERE: ");
    scanf("%[^\n]",ch);
    ...
    printf("Created by Yuvraj Malhotra");
     return 0;
}
